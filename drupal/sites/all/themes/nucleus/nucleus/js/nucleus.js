...
Drupal.Nucleus.changeGrid = function(element) {
  ...
  if(select) {
    ...
    $('select[name="layout_width_selector"] option').remove();
    var min_width = 900;
    var max_width = 1080;
  ...
  for (var x in Drupal.Nucleus.widthSelectNames) {
    Drupal.Nucleus.updateGridOptions(Drupal.Nucleus.widthSelectNames[x], grid);
  }
