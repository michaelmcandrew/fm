...
<div id="page" class="page-default"> <a name="Top" id="Top"></a>
  ...
  <div id="headline-wrapper" class="wrapper">
    <div class="container <?php print $grid; ?>">
      <div class="grid-inner clearfix"> <?php print $headline; ?> </div>
    </div>
  </div>
  <!-- //HEADLINE -->
  <?php endif;?>
  ...
  <div id="main-wrapper" class="wrapper">
    <div class="container <?php print $grid; ?> clearfix">
      <div class="container-inner <?php print nucleus_group_class("mass_top, content, sidebar_first");?> ">
        <?php if ($mass_top = render($page['mass_top'])): ?>
        <!-- MASS TOP -->
        <div class="mass-top">
          <div class="grid-inner clearfix"> <?php print($mass_top);?> </div>
        </div>
        <!-- //MASS TOP -->
        <?php endif; ?>
  ...
  <div id="panel-bottom-wrapper" class="wrapper panel panel-bottom">
    <div class="container <?php print $grid;?> clearfix"> <?php print $panel_bottom;?> </div>
  </div>
  <!-- //PANEL BOTTOM -->
  <?php endif; ?>
  <?php if($breadcrumb): ?>
  <div id="breadcrumb-wrapper" class="wrapper clearfix">
    <div class="container <?php print $grid;?> clearfix"><?php print $breadcrumb; ?></div>
  </div>
  <?php endif; ?>
